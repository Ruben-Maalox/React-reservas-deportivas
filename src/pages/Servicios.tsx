...
export default function Servicios() {
  const images = [
    ...
    { src: clasesVolleyImg, alt: "Clases de volleyball", descr: "Clases de volleyball desde iniciación hasta federado" },
  ];
    ...
    <div className="flex flex-col items-center justify-center">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 m-4">
        {images && images.map((image, index)=>{
          return(
            <div key={index} id={`servicios-${image.alt}`} className="overflow-hidden shadow-lg rounded-lg h-96 w-64 cursor-pointer m-auto">
