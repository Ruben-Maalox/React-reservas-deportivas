...
export default function Reservas() {
  ...
  return (
    <>
      <main style={{ backgroundImage: `url(${backgroundImage})` }} className="relative flex min-h-screen flex-col items-center p-4 bg-gray-100 text-black bg-no-repeat bg-cover">
        ...
        <label htmlFor="toggle" className="text-white absolute top-10 right-4 text-gray-700 font-medium">
