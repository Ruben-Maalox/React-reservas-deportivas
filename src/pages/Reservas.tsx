...
export default function Reservas() {
  const [showOwnReservations, setShowOwnReservations] =
  ...
  return (
    <>
      ...
      >
        ...
        <label htmlFor="toggle" className="text-white absolute top-10 right-4 font-medium">
          {showOwnReservations ? "Ver todas las reservas" : "Ver mis reservas"}
        </label> */}

        <label className="absolute top-5 right-5 flex flex-col items-center cursor-pointer">
          <input
            type="checkbox"
            id="toggle"
