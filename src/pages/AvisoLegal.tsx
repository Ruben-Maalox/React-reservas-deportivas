  ...
  return (
    <div className="container mx-auto p-4">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          La titularidad de este sitio web, https://www.letsmove.com, (en adelante, Sitio Web) la ostenta: Ruben asdasd,
          con NIF: 12312312-R, y cuyos datos de contacto son:
        </p>
      ...
      <section className="mb-8">
        ...
        <p>
          ...
          coste de conexión a través de la red de telecomunicaciones suministrada por el proveedor de acceso que hubiere
        ...
        <p>
          El acceso, la navegación y uso del Sitio Web, confiere la condición de Usuario, por lo que se aceptan, desde
          que se inicia la navegación por el Sitio Web, todas las Condiciones aquí establecidas, así como sus ulteriores
        ...
        <p>
          El Sitio Web de Lets Move proporciona gran diversidad de información, servicios y datos. El Usuario asume su
          responsabilidad para realizar un uso correcto del Sitio Web. Esta responsabilidad se extenderá a:
        </p>

        <ul className="list-disc list-inside mb-4">
          <li>
            Un uso de la información, Contenidos y/o Servicios y datos ofrecidos por Lets Move sin que sea contrario a
            lo dispuesto por las presentes Condiciones, la Ley, la moral o el orden público, o que de cualquier otro
            modo puedan suponer lesión de los derechos de terceros o del mismo funcionamiento del Sitio Web.
          </li>
          <li>
            La veracidad y licitud de las informaciones aportadas por el Usuario en los formularios extendidos por Lets
            Move para el acceso a ciertos Contenidos o Servicios ofrecidos por el Sitio Web.
          </li>
          <li>
            El mero acceso a este Sitio Web no supone entablar ningún tipo de relación de carácter comercial entre Lets
            Move y el Usuario.
          </li>
        </ul>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>
          Lets Move no garantiza la continuidad, disponibilidad y utilidad del Sitio Web, ni de los Contenidos o
          Servicios. Lets Move hará todo lo posible por el buen funcionamiento del Sitio Web, sin embargo, no se
        ...
        <p>
          ...
          Sitio Web, esté libre de error o cause un daño al sistema informático (software y hardware) del Usuario. En
          ningún caso Lets Move será responsable por las pérdidas, daños o perjuicios de cualquier tipo que surjan por
          el acceso, navegación y el uso del Sitio Web, incluyéndose, pero no limitándose, a los ocasionados a los
          sistemas informáticos o los provocados por la introducción de virus.
        </p>

        <p>
          Lets Move tampoco se hace responsable de los daños que pudiesen ocasionarse a los usuarios por un uso
      ...
      <section className="mb-8">
        ...
        <p>
          Lets Move no ofrece ni comercializa por sí ni por medio de terceros los productos y/o servicios disponibles en
        ...
        <p>
          ...
          Web de Lets Move deberá saber que:
        </p>

        <ul className="list-disc list-inside mb-4">
          <li>
            No se permite la reproducción —total o parcialmente— de ninguno de los Contenidos y/o Servicios del Sitio
            Web sin autorización expresa de Lets Move.
          </li>
          <li>
            No se permite tampoco ninguna manifestación falsa, inexacta o incorrecta sobre el Sitio Web de Lets Move, ni
          ...
          <li>
            ...
            salvo autorización expresa de Lets Move.
          </li>
          <li>
            El establecimiento del hipervínculo no implicará la existencia de relaciones entre Lets Move y el titular
            del sitio web desde el cual se realice, ni el conocimiento y aceptación de Lets Move de los contenidos,
      ...
      <section className="mb-8">
        ...
        <p>
          Lets Move por sí o como parte cesionaria, es titular de todos los derechos de propiedad intelectual e
        ...
        <p>
          ...
          siéndoles aplicables tanto la normativa española y comunitaria en este campo, como los tratados
        ...
        <p>
          ...
          cualquier soporte y por cualquier medio técnico, sin la autorización de Lets Move.
        </p>

        <p>
          El Usuario se compromete a respetar los derechos de propiedad intelectual e industrial de Lets Move. Podrá
        ...
        <p>
          ...
          violación de los derechos de protección de la propiedad intelectual, deberá comunicarlo inmediatamente a Lets
          Move a través de los datos de contacto del apartado de INFORMACIÓN GENERAL de este Aviso Legal y Condiciones
          Generales de Uso.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p>
          Lets Move se reserva la facultad de presentar las acciones civiles o penales que considere necesarias por la
          utilización indebida del Sitio Web y Contenidos, o por el incumplimiento de las presentes Condiciones.
        </p>

        <p>
          La relación entre el Usuario y Lets Move se regirá por la normativa vigente y de aplicación en el territorio
        ...
        <p>
          ...
          generador de plantilla de aviso legal y condiciones de uso online el día 16/07/2021.
        </p>
      </section>
    </div>
  );
